...
/**
 * {@link Applet <TT>java.applet.Applet</TT>}
 * with a channel interface, specialising in the operation
 * of {@link CSProcess} networks as <I>applets</I>.
 * <P>
 * <A HREF="#constructor_summary">Shortcut to the Constructor and Method Summaries.</A>
 * <H2>Description</H2>
 * <TT>ActiveApplet</TT> is an extension of {@link Applet} to simplify
 * the management of an associated {@link CSProcess}.  There are three
 * areas of provision:
 * <UL>
 *   <LI>
 ...
 * on the defining ({@link Parallel}) process from the <TT>main</TT> thread of control.
 ...
 * by using a {@link ProcessManager}.
 * <P>
 * We could do this by directly extending the {@link Applet} class and
 ...
 * {@link CSProcess} and register it with this <TT>ActiveApplet</TT>
 ...
 * {@link ActiveApplet#setDestroyChannels(ChannelOutputInt, AltingChannelInputInt,int) when the channels are set}.
 * <P>
 ...
 * An <TT>ActveApplet</TT> extends a {@link Applet <TT>java.applet.Applet</TT>}
 ...
 *   <TR>
 *     <TH>configure</TH>
 *     <TD>{@link Configure ActiveApplet.Configure}</TD>
 ...
 * <UL>
 *   <LI>
 *      {@link Alternative <I>ALTing</I>} between guards (a channel
 *      communication and a timeout);
 *   <LI>
 *      {@link Alternative <I>ALTing</I>} with <I>pre-conditions</I>
 ...
 *      objects - see the note in {@link Configure}).
 * </UL>
