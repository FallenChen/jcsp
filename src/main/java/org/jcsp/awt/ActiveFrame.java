...
/**
 * {@link Frame <TT>java.awt.Frame</TT>}
...
public class ActiveFrame extends Frame implements CSProcess
{
   /**
   ...
   /**
    * Constructs a new <TT>ActiveFrame</TT> with no title and no configuration
    * or event channels.
    *
    */
   public ActiveFrame()
   ...
   /**
    * Constructs a new <TT>ActiveFrame</TT> with a title but no configuration
    * or event channels.
    *
   ...
   /**
    * Constructs a new <TT>ActiveFrame</TT> with configuration
    ...
    */
   public ActiveFrame(ChannelInput configure, ChannelOutput event)
   {
    ...
    * @param title the title for the frame.
    */
   public ActiveFrame(ChannelInput configure, ChannelOutput event, String title)
   {   
      super(title);  
      if (event != null)
      {
   ...
   /**
    * Sets the configuration channel for this <TT>ActiveFrame</TT>.
   ...
   static public interface Configure
   {
       ...
       */
      public void configure(final Frame frame);
   }
