...
/**
 * {@link Window <TT>java.awt.Window</TT>}
 * with a channel interface.
 * <H2>Process Diagram</H2>
 * <p><img src="doc-files/ActiveWindow1.gif"></p>
 * <H2>Description</H2>
 * <TT>ActiveWindow</TT> is a process extension of <TT>java.awt.Window</TT>
 ...
 *           the window is made visible</LI>
 *         <LI>If this is the <TT>Boolean.FALSE</TT> object,
 *            the window is made invisible</LI>
 *         <LI>Other <TT>Boolean</TT> objects are ignored</LI>
 *       </OL>
 *     </TD>
 *   </TR>
 *   <TR>
 *     <TD>ActiveWindow.Configure</TD>
 *     <TD>Invoke the user-defined <TT>Configure.configure</TT> method on the window.</TD>
 *   </TR>
 *   <TR>
...
public class ActiveWindow extends Window implements CSProcess
{
   ...
   /**
    * Constructs a new <TT>ActiveWindow</TT>.
    *
    ...
    * @param f the parent frame for the window.
    */
   public ActiveWindow(ChannelInput configure, ChannelOutput event, Frame f)
   {
      super(f);
      if (event != null)
      {
   ...
   /**
    * Sets the configuration channel for this <TT>ActiveWindow</TT>.
